...
#
# Usage:
#   ./scripts/train_stage2.sh <world_model_ckpt> [extra hydra overrides...]
#
# Examples:
#   ./scripts/train_stage2.sh ~/.stable_worldmodel/models/abc123/lewm_so100_epoch_100_object.ckpt
...
if [[ $# -lt 1 ]]; then
    echo "Usage: $0 <world_model_ckpt_path> [hydra overrides...]"
    echo ""
    echo "Example:"
    echo "  $0 ~/.stable_worldmodel/models/abc123/lewm_so100_epoch_100_object.ckpt"
    exit 1
fi
...
echo "  Config:      config/train/gc_idm.yaml"
echo "============================================================"

python train_gc_idm.py "world_model_path=$WM_CKPT" "$@"
